...
3. Cross cell rule : The left neighbour of an 'X ' cell must be either another 'X ' cell or a 'U ' cell, and the upper neighbour of an 'X ' cell must be either another 'X ' cell or an 'L ' cell.
